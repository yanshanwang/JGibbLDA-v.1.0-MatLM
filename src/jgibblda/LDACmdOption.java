...
public class LDACmdOption {
	...
	@Option(name="-inputdir", usage="Specify directory")
	...
	@Option(name="-modelDir", usage="Specify the model dir name")
	...
	@Option(name="-inputFormat", usage="Specify the input format")
	public String inputFormat = "title:meshMajor:abstractText:pmid:firstMeshMajor";
	
	@Option(name="-source", usage="Specify the source file")
	public String source = "json:bioasq";
